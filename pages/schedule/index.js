...
import { getScheduleByDoctorId, createSchedule, updateSchedule } from '../../redux/action/scheduleAction';
...
const Schedule = () => {
  ...
  const addOrUpdateDay = () => {
    ...
    if (existingDayIndex !== -1) {
      ...
      // Update the existing schedule in the backend
  ...
  return (
    <div className="container mx-auto mt-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-[#019874]">Dummy Schedule Page</h1>
      <div className="flex justify-center items-center mb-4">
        <label className="mr-2">Select Day:</label>
        <select value={selectedDay} onChange={(e) => setSelectedDay(e.target.value)} className="mr-4">
